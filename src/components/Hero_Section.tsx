...
const Hero_section = () => {
  return (
    <div className="container mx-auto mt-20 flex flex-col justify-start items-center h-screen" style={{ paddingLeft: '100px', paddingRight: "100px" }}>
      <div >
        <img src={require('../images/lemon.png')} className='absolute left-10' />
        <img src={require('../images/leaf.png')} className='absolute right-10'/>
      </div>

      <div className="relative">
        <div className="flex top-80 -left-16 sm:-left-12 sm:top-80 md:top-72 md:right-32 justify-center items-center relative">
        ...
        <div className="text-white text-8xl top-36 sm:top-40 md:text-8.8xl md:top-16 lg:text-9xl font-semibold text-center relative z-10">
      ...
      <div>
        <img src={require('../images/black_fruit.png')} className='absolute left-96' />
      </div>
      ...
      <div className="flex relative w-full justify-center items-center mt-24">
        <div className='absolute top-64 sm:top-56 sm:-right-28 md:top-32 md:-right-36 lg:top-0 lg:right-0 right-0 flex'>
      ...
      <div className="relative hidden sm:hidden md:top-36 lg:top-0 lg:block">
        <img src={require('../images/scrollLogo.png')} className=''/>
      </div>
    </div>
  );
};
